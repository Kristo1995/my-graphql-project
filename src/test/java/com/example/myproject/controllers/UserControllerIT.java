...
public class UserControllerIT {
    ...
    public void users() {
        ...
        graphQlTester
                ...
                .path("users[0].username").entity(String.class).isEqualTo("foo")
                .path("users[0].contractId").entity(String.class).isEqualTo("1ABC")
                .path("users[1].id").entity(Long.class).isEqualTo(2L)
                .path("users[1].username").entity(String.class).isEqualTo("bar")
    ...
    public void user() {
        ...
        graphQlTester
                ...
                .path("user.username").entity(String.class).isEqualTo("foo")
    ...
    public void addUser() {
        ...
        when(passwordEncoder.encode("fooPassword")).thenReturn("fooPassword");

        graphQlTester
                .documentName("addUser")
                .variable("username", "foo")
                .variable("password", "fooPassword")
                .execute()
                .path("addUser.id").entity(Long.class).isEqualTo(1L)
                .path("addUser.username").entity(String.class).isEqualTo("foo");
    }
